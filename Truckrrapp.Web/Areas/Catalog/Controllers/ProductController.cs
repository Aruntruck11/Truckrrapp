using Truckrrapp.Application.Constants;
...
using Truckrrapp.Application.Features.Products.Commands.Delete;
...
using Truckrrapp.Web.Abstractions;
using Truckrrapp.Web.Areas.Catalog.Models;
using Truckrrapp.Web.Extensions;
...
namespace Truckrrapp.Web.Areas.Catalog.Controllers
{
    [Area("Catalog")]
