using Truckrrapp.Application.DTOs.Identity;
using Truckrrapp.Application.DTOs.Mail;
using Truckrrapp.Application.DTOs.Settings;
using Truckrrapp.Application.Enums;
using Truckrrapp.Application.Exceptions;
...
namespace Truckrrapp.Infrastructure.Identity.Services
{
