using Truckrrapp.Api.Services;
using Truckrrapp.Application.DTOs.Settings;
using Truckrrapp.Application.Interfaces;
using Truckrrapp.Application.Interfaces.Shared;
using Truckrrapp.Infrastructure.DbContexts;
using Truckrrapp.Infrastructure.Identity.Models;
using Truckrrapp.Infrastructure.Identity.Services;
using Truckrrapp.Infrastructure.Shared.Services;
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        private static void RegisterSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                ...
                c.IncludeXmlComments(string.Format(@"{0}\Truckrrapp.Api.xml", System.AppDomain.CurrentDomain.BaseDirectory));
